...
## PrimitiveValueComparer.Equals(short, float) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(short,float).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(short,float).y'></a>
