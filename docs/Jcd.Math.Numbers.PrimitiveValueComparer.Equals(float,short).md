...
## PrimitiveValueComparer.Equals(float, short) Method

Checks a Single and a Int16 for equality

```csharp
public static bool Equals(float x, short y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,short).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,short).y'></a>
