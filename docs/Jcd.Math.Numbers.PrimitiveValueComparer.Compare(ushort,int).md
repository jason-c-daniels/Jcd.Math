...
## PrimitiveValueComparer.Compare(ushort, int) Method

Compares a UInt16 to a Int32

```csharp
public static int Compare(ushort x, int y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,int).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,int).y'></a>
