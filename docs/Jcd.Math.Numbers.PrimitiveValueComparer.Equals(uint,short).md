...
## PrimitiveValueComparer.Equals(uint, short) Method

Checks a UInt32 and a Int16 for equality

```csharp
public static bool Equals(uint x, short y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,short).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,short).y'></a>
