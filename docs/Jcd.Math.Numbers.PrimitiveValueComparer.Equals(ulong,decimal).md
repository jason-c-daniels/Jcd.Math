...
## PrimitiveValueComparer.Equals(ulong, decimal) Method

Checks a UInt64 and a Decimal for equality

```csharp
public static bool Equals(ulong x, decimal y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ulong,decimal).x'></a>

`x` [System.UInt64](https://docs.microsoft.com/en-us/dotnet/api/System.UInt64 'System.UInt64')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ulong,decimal).y'></a>
