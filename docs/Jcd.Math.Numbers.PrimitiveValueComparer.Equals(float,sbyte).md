...
## PrimitiveValueComparer.Equals(float, sbyte) Method

Checks a Single and a SByte for equality

```csharp
public static bool Equals(float x, sbyte y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,sbyte).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,sbyte).y'></a>
