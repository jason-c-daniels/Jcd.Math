...
## PrimitiveValueComparer.Compare(long, ushort) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(long,ushort).x'></a>

`x` [System.Int64](https://docs.microsoft.com/en-us/dotnet/api/System.Int64 'System.Int64')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(long,ushort).y'></a>
