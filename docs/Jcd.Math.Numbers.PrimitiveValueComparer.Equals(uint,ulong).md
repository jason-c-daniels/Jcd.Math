...
## PrimitiveValueComparer.Equals(uint, ulong) Method

Checks a UInt32 and a UInt64 for equality

```csharp
public static bool Equals(uint x, ulong y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,ulong).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,ulong).y'></a>
