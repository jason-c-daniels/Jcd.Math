...
## PrimitiveValueComparer.Equals(float, ulong) Method

Checks a Single and a UInt64 for equality

```csharp
public static bool Equals(float x, ulong y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,ulong).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,ulong).y'></a>
