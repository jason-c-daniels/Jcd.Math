...
## PrimitiveValueComparer.Equals(ushort, uint) Method

Checks a UInt16 and a UInt32 for equality

```csharp
public static bool Equals(ushort x, uint y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ushort,uint).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ushort,uint).y'></a>
