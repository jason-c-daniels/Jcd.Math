...
## PrimitiveValueComparer.Equals(short, uint) Method

Checks a Int16 and a UInt32 for equality

```csharp
public static bool Equals(short x, uint y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(short,uint).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(short,uint).y'></a>
