...
## PrimitiveValueComparer.Compare(sbyte, int) Method

Compares a SByte to a Int32

```csharp
public static int Compare(sbyte x, int y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,int).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,int).y'></a>
