...
## PrimitiveValueComparer.Compare(ushort, short) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,short).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,short).y'></a>
