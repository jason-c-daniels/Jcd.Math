...
## PrimitiveValueComparer.Compare(sbyte, double) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,double).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,double).y'></a>
