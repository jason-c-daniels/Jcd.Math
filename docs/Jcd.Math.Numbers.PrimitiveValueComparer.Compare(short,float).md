...
## PrimitiveValueComparer.Compare(short, float) Method

Compares a Int16 to a Single

```csharp
public static int Compare(short x, float y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,float).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,float).y'></a>
