...
## PrimitiveValueComparer.Equals(long, float) Method

Checks a Int64 and a Single for equality

```csharp
public static bool Equals(long x, float y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(long,float).x'></a>

`x` [System.Int64](https://docs.microsoft.com/en-us/dotnet/api/System.Int64 'System.Int64')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(long,float).y'></a>
