...
## PrimitiveValueComparer.Compare(int, ushort) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(int,ushort).x'></a>

`x` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(int,ushort).y'></a>
