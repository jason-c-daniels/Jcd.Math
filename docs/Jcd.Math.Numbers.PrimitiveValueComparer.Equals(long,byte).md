...
## PrimitiveValueComparer.Equals(long, byte) Method

Checks a Int64 and a Byte for equality

```csharp
public static bool Equals(long x, byte y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(long,byte).x'></a>

`x` [System.Int64](https://docs.microsoft.com/en-us/dotnet/api/System.Int64 'System.Int64')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(long,byte).y'></a>
