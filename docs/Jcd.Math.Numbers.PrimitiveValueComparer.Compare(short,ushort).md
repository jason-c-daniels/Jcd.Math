...
## PrimitiveValueComparer.Compare(short, ushort) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,ushort).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,ushort).y'></a>
