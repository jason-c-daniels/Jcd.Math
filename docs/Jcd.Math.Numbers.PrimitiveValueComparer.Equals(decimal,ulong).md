...
## PrimitiveValueComparer.Equals(decimal, ulong) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(decimal,ulong).x'></a>

`x` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(decimal,ulong).y'></a>
