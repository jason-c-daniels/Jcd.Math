...
## PrimitiveValueComparer.Equals(sbyte, long) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,long).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,long).y'></a>
