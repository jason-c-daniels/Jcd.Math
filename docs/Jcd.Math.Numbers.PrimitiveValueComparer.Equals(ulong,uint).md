...
## PrimitiveValueComparer.Equals(ulong, uint) Method

Checks a UInt64 and a UInt32 for equality

```csharp
public static bool Equals(ulong x, uint y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ulong,uint).x'></a>

`x` [System.UInt64](https://docs.microsoft.com/en-us/dotnet/api/System.UInt64 'System.UInt64')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ulong,uint).y'></a>
