...
## PrimitiveValueComparer.Equals(ushort, decimal) Method

Checks a UInt16 and a Decimal for equality

```csharp
public static bool Equals(ushort x, decimal y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ushort,decimal).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(ushort,decimal).y'></a>
