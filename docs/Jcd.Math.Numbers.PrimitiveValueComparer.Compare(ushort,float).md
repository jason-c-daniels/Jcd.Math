...
## PrimitiveValueComparer.Compare(ushort, float) Method

Compares a UInt16 to a Single

```csharp
public static int Compare(ushort x, float y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,float).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(ushort,float).y'></a>
