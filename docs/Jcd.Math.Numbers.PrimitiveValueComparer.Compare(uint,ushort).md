...
## PrimitiveValueComparer.Compare(uint, ushort) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(uint,ushort).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(uint,ushort).y'></a>
