...
## PrimitiveValueComparer.Equals(sbyte, ushort) Method

Checks a SByte and a UInt16 for equality

```csharp
public static bool Equals(sbyte x, ushort y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,ushort).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,ushort).y'></a>
