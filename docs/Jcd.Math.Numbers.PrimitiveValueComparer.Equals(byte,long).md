...
## PrimitiveValueComparer.Equals(byte, long) Method

Checks a Byte and a Int64 for equality

```csharp
public static bool Equals(byte x, long y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,long).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,long).y'></a>
