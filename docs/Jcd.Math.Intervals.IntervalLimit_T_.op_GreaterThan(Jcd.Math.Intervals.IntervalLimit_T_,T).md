...
<a name='Jcd.Math.Intervals.IntervalLimit_T_.op_GreaterThan(Jcd.Math.Intervals.IntervalLimit_T_,T).left'></a>
...
<a name='Jcd.Math.Intervals.IntervalLimit_T_.op_GreaterThan(Jcd.Math.Intervals.IntervalLimit_T_,T).right'></a>
...
True if the interval limit is greater than the specified value.