...
## PrimitiveValueComparer.Equals(byte, float) Method

Checks a Byte and a Single for equality

```csharp
public static bool Equals(byte x, float y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,float).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,float).y'></a>
