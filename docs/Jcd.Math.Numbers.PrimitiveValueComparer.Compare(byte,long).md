...
## PrimitiveValueComparer.Compare(byte, long) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(byte,long).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(byte,long).y'></a>
