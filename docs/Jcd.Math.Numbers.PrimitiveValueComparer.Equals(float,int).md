...
## PrimitiveValueComparer.Equals(float, int) Method

Checks a Single and a Int32 for equality

```csharp
public static bool Equals(float x, int y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,int).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(float,int).y'></a>
