...
## PrimitiveValueComparer.Compare(decimal, ushort) Method

Compares a Decimal to a UInt16

```csharp
public static int Compare(decimal x, ushort y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(decimal,ushort).x'></a>

`x` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(decimal,ushort).y'></a>
