...
<a name='Jcd.Math.Intervals.IntervalLimit_T_.op_Equality(T,Jcd.Math.Intervals.IntervalLimit_T_).left'></a>
...
<a name='Jcd.Math.Intervals.IntervalLimit_T_.op_Equality(T,Jcd.Math.Intervals.IntervalLimit_T_).right'></a>
