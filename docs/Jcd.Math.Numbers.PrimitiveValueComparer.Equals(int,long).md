...
## PrimitiveValueComparer.Equals(int, long) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(int,long).x'></a>

`x` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(int,long).y'></a>
