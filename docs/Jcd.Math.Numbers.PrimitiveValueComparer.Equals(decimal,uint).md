...
## PrimitiveValueComparer.Equals(decimal, uint) Method

Checks a Decimal and a UInt32 for equality

```csharp
public static bool Equals(decimal x, uint y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(decimal,uint).x'></a>

`x` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(decimal,uint).y'></a>
