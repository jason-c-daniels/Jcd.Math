...
## PrimitiveValueComparer.Compare(sbyte, byte) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,byte).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(sbyte,byte).y'></a>
