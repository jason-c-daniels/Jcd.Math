...
## PrimitiveValueComparer.Compare(short, sbyte) Method

Compares a Int16 to a SByte

```csharp
public static int Compare(short x, sbyte y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,sbyte).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(short,sbyte).y'></a>
