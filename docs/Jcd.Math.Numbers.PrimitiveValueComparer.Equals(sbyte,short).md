...
## PrimitiveValueComparer.Equals(sbyte, short) Method

Checks a SByte and a Int16 for equality

```csharp
public static bool Equals(sbyte x, short y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,short).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(sbyte,short).y'></a>
