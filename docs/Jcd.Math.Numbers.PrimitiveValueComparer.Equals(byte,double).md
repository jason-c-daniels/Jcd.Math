...
## PrimitiveValueComparer.Equals(byte, double) Method
...
<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,double).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(byte,double).y'></a>
