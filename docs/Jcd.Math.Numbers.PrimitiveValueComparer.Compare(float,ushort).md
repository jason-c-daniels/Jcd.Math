...
## PrimitiveValueComparer.Compare(float, ushort) Method

Compares a Single to a UInt16

```csharp
public static int Compare(float x, ushort y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,ushort).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,ushort).y'></a>
