...
## PrimitiveValueComparer.Compare(float, long) Method

Compares a Single to a Int64

```csharp
public static int Compare(float x, long y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,long).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,long).y'></a>
