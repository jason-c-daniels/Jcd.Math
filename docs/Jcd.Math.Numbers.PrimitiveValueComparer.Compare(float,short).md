...
## PrimitiveValueComparer.Compare(float, short) Method

Compares a Single to a Int16

```csharp
public static int Compare(float x, short y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,short).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Compare(float,short).y'></a>
