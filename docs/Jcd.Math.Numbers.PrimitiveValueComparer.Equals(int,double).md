...
## PrimitiveValueComparer.Equals(int, double) Method

Checks a Int32 and a Double for equality

```csharp
public static bool Equals(int x, double y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(int,double).x'></a>

`x` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(int,double).y'></a>
