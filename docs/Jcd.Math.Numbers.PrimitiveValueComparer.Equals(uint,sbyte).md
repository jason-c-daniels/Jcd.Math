...
## PrimitiveValueComparer.Equals(uint, sbyte) Method

Checks a UInt32 and a SByte for equality

```csharp
public static bool Equals(uint x, sbyte y);
```
#### Parameters

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,sbyte).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Math.Numbers.PrimitiveValueComparer.Equals(uint,sbyte).y'></a>
